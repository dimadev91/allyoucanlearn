...
import 'package:all_you_learn/python/functions_python_basics/API_request_analysis.dart';
...
class QuizPythonAnalysis extends StatefulWidget {
  const QuizPythonAnalysis({super.key});

  @override
  State<QuizPythonAnalysis> createState() => QuizPythonAnalysisState();
}

class QuizPythonAnalysisState extends State<QuizPythonAnalysis> {
