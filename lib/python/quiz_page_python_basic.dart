...
import 'package:all_you_learn/python/functions_python_basics/API_request_basic.dart';
...
class QuizPagePython extends StatefulWidget {
  const QuizPagePython({super.key});

  @override
  State<QuizPagePython> createState() => QuizPagePythonState();
}

class QuizPagePythonState extends State<QuizPagePython> {
