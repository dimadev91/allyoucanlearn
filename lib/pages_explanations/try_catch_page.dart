...
import 'package:all_you_learn/explanations/try_catch_explanation.dart';
...
class TryCatchPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: Center(child: Text('TRY, CATCH, THROW', style: kTextTitle)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            TextExplanationObj(text: exTryCatch), //class
          ],
        ),
      ),
