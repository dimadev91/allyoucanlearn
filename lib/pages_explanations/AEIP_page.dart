...
import 'package:all_you_learn/explanations/AEIP_explanation.dart';
...
class AeipPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: Center(child: Text('AEIP', style: kTextTitle)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            TextExplanationObj(text: exAEIP), //Explain material app
            SizedBox(height: 20),
            InteractiveViewer(
              panEnabled: true,
              minScale: 1,
              maxScale: 4,
              child: Image.asset('assets/pages_assets/aeip.png'),
            ), //code example
          ],
        ),
      ),
