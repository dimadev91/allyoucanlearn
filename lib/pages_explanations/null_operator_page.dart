...
import 'package:all_you_learn/explanations/null_operator_explanation.dart';
...
class NullOperatorPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: Center(child: Text('NULL OPERATOR', style: kTextTitle)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            TextExplanationObj(text: exNullOperator), //class
          ],
        ),
      ),
