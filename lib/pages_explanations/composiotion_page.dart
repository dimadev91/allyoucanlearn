...
class ComposiotionPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: Center(child: Text('COMPOSITION', style: kTextTitle)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            TextExplanationObj(text: exComposition), //Explain material app
          ],
        ),
      ),
