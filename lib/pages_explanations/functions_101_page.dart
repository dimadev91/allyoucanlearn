...
import 'package:all_you_learn/explanations/functions_101.dart';
...
class Functions101Page extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: Center(child: Text('FUNCTIONS 101', style: kTextTitle)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            TextExplanationObj(text: exFunctionsAndMethods),
            SizedBox(height: 20),
            InteractiveViewer(
              panEnabled: true,
              minScale: 1,
              maxScale: 4,
              child: Image.asset('assets/pages_assets/input1.png'),
            ),
            InteractiveViewer(
              panEnabled: true,
              minScale: 1,
              maxScale: 4,
              child: Image.asset('assets/pages_assets/input2.png'),
            ),
          ],
        ),
      ),
