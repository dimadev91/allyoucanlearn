...
import 'package:all_you_learn/explanations/ternary_operator_explanation.dart';
...
class TernaryOperatorPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: Center(child: Text('TERNARY OPERATOR', style: kTextTitle)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            TextExplanationObj(text: exTernaryOperator), //Explain material app
            SizedBox(height: 20),
            InteractiveViewer(
              panEnabled: true,
              minScale: 1,
              maxScale: 4,
              child: Image.asset('assets/pages_assets/ternary.png'),
            ), //code example
          ],
        ),
      ),
