...
class DiceRollCode extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.asset('assets/dice/DiceCode-1.png'),
            Image.asset('assets/dice/DiceCode-2.png'),
            Image.asset('assets/dice/DiceCode-3.png'),
          ],
        ),
      ),
